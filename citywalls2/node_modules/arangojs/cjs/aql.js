...
function aql(templateStrings, ...args) {
    ...
    for (let i = 0; i < args.length; i++) {
        ...
        if ((0, collection_js_1.isArangoCollection)(rawValue) ||
            (0, graph_js_1.isArangoGraph)(rawValue) ||
            (0, view_js_1.isArangoView)(rawValue) ||
            (0, analyzer_js_1.isArangoAnalyzer)(rawValue)) {
            name = `@${name}`;
            value = rawValue.name;
        }
        if (!isKnown) {
